...
const products = [
  ...
  },
  {
    ...
    description:
      "Essential oils and natural extracts selected and evaluated to perfumer&apos;s standard.",
    items: [
      {
        name: "Lavender Oil",
        latin: "French Lavender",
        desc: "Fresh, clean, floral, sweet aroma and herbal-sweet undertones.",
        tags: ["Perfumery", "Cosmetics", "Aromatherapy", "Flavour"],
      },
      {
        name: "Lemon Oil",
        latin: "Citrus limon - Sicilian",
        desc: "Strong, fresh, clean, lemony aroma with a sweet, floral, and slightly bitter undertone.",
        tags: ["Flavour", "Food & Beverage"],
      },
      {
        name: "Lemon Verbena Oil",
        latin: "Aloysia citrodora",
        desc: "Fresh, sweet, intensely lemony, with citrusy, herbaceous, and floral notes.",
        tags: ["Perfumery", "Cosmetics", "Aromatherapy"],
      },
      {
        name: "Lime Oil",
        latin: "Citrus aurantifolia - Persian",
        desc: "Sharp, fresh, distinctly citrusy, and slightly sweet aroma.",
        tags: ["Flavour", "Food & Beverage"],
      },
      {
        name: "Mandarin Oil",
        latin: "Sweet, juicy, fresh, and fruity aroma with a slightly floral and spicy undertone.",
        desc: "Perfumery. Cosmetics. Aromatherapy. Flavour",
        tags: ["BOTH"],
      },
      {
        name: "Neroli Oil",
        latin: "Orange Blossom Absolute, with a sweet, intense, floral, and honey-like aroma.",
        desc: "Perfumery. Cosmetics. Aromatherapy",
        tags: ["BOTH"],
      },
      {
        name: "Orange Oil",
        latin: "Sweet Orange oil, a sweet, fresh, and uplifting citrus aroma.",
        desc: "Perfumery. Cosmetics. Aromatherapy. Flavour",
        tags: ["BOTH"],
      },
      {
        name: "Oregano Oil",
        latin: "Pungent, strong, herbaceous, and spicy aroma with medicinal undertones.",
        desc: "Pharma. Food & Beverage",
        tags: ["BOTH"],
      },
      {
        name: "Patchouli Oil",
        latin: "Deep, rich, earthy, woody, and sweet aroma with balsamic and slightly camphoraceous undertones.",
        desc: "Perfumery. Cosmetics. Aromatherapy",
        tags: ["BOTH"],
      },
      {
        ...
        desc: "Fresh, cool, minty, and penetrating aroma.",
        tags: ["Flavour", "Food & Beverage", "Oral Care", "Perfumery", "Cosmetics"],
      },
      {
        name: "Rose Absolute",
        latin: "Indian Rose Absolute, with a rich, intensely sweet, deep, floral, and slightly spicy aroma.",
        desc: "Perfumery. Cosmetics. Aromatherapy",
        tags: ["BOTH"],
      },
      {
        name: "Rosemary Oil",
        latin: "Aromatic, herbaceous, camphorous, and slightly woody aroma.",
        desc: "Perfumery. Cosmetics. Aromatherapy. Flavour",
        tags: ["BOTH"],
      },
      {
        name: "Sandalwood Oil",
        latin: "Exotic, woody, sweet, and rich aroma with a creamy and balsamic undertone.",
        desc: "Perfumery. Cosmetics. Aromatherapy",
        tags: ["BOTH"],
      },
      {
        name: "Spearmint Oil",
        latin: "Mentha spicata",
        desc: "Sweet, fresh, minty, and herbaceous aroma with a slightly softer and sweeter profile than peppermint.",
        tags: ["Flavour", "Food & Beverage", "Oral Care", "Perfumery", "Cosmetics"],
      },
      {
        name: "Tea Tree Oil",
        latin: "Melaleuca alternifolia",
        desc: "Fresh, clean, medicinal, camphorous, and herbaceous aroma with a warm, woody undertone.",
        tags: ["Pharma", "Cosmetics", "Aromatherapy"],
      },
      {
        name: "Vetiver Oil",
        latin: "Earthy, woody and smoky-rooty with a sweet balsamic depth; profoundly grounding.",
        desc: "Fine fragrance. Specialty",
        tags: ["BOTH"],
      },
      {
        name: "Ylang Ylang Oil",
        latin: "Sweet, exotic, floral, and fruity aroma with a creamy and balsamic undertone.",
        desc: "Perfumery. Cosmetics. Aromatherapy",
        tags: ["BOTH"],
      },
    ],

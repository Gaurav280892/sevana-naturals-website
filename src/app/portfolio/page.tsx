  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        desc: "Sweet, juicy, fresh, and fruity aroma with a slightly floral and spicy undertone.",
        tags: ["Perfumery", "Cosmetics", "Aromatherapy", "Flavour"],
      },
      {
        name: "Neroli Oil",
        latin: "Citrus aurantium - Orange Blossom",
        desc: "Sweet, intense, floral, and honey-like aroma.",
        tags: ["Perfumery", "Cosmetics", "Aromatherapy"],
      },
      {
        name: "Orange Oil",
        latin: "Citrus sinensis - Sweet Orange",
        desc: "Sweet, fresh, and uplifting citrus aroma.",
        tags: ["Perfumery", "Cosmetics", "Aromatherapy", "Flavour"],
      },
      {
        name: "Oregano Oil",
        latin: "Origanum vulgare",
        desc: "Pungent, strong, herbaceous, and spicy aroma with medicinal undertones.",
        tags: ["Pharma", "Food & Beverage"],
      },
      {
        name: "Patchouli Oil",
        latin: "Pogostemon cablin",
        desc: "Deep, rich, earthy, woody, and sweet aroma with balsamic and slightly camphoraceous undertones.",
        tags: ["Perfumery", "Cosmetics", "Aromatherapy"],
      },
      {
        name: "Rose Absolute",
        latin: "Rosa damascena - Indian",
        desc: "Rich, intensely sweet, deep, floral, and slightly spicy aroma.",
        tags: ["Perfumery", "Cosmetics", "Aromatherapy"],
      },
      {
        name: "Rosemary Oil",
        latin: "Rosmarinus officinalis",
        desc: "Aromatic, herbaceous, camphorous, and slightly woody aroma.",
        tags: ["Perfumery", "Cosmetics", "Aromatherapy", "Flavour"],
      },
      {
        name: "Sandalwood Oil",
        latin: "Santalum album",
        desc: "Exotic, woody, sweet, and rich aroma with a creamy and balsamic undertone.",
        tags: ["Perfumery", "Cosmetics", "Aromatherapy"],
      },
      {
        name: "Tea Tree Oil",
      ...
      },
      {
        ...
        desc: "Earthy, woody and smoky-rooty with a sweet balsamic depth; profoundly grounding.",
        tags: ["Fine Fragrance", "Specialty"],
      },
      {
        name: "Ylang Ylang Oil",
        latin: "Cananga odorata",
        desc: "Sweet, exotic, floral, and fruity aroma with a creamy and balsamic undertone.",
        tags: ["Perfumery", "Cosmetics", "Aromatherapy"],
      },
    ],
  },
